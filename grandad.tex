...
%
% to do:
% - a section on the dogs in his life
% - sale of Ash Road, moving to Beaulieu Rd, inheritance from his father (split with Aunty Pam), promotion
% - support from neighbours at 4 South Lane
% - civil service
...
\paragraph{1931} Aunty Pam was born; Grandad had a close relationship with her throughout their
...
\begin{wrapfigure}{R}{.4\textwidth}
	\centering
	\rotatebox{-90}{\includegraphics[width=.9\textwidth]{portrait}}
\end{wrapfigure}
...
\begin{wrapfigure}[14]{R}{5cm}
	\centering
	\rotatebox{-90}{\includegraphics[width=.6\textwidth]{squadron104badge}}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{.5\textwidth}
	\centering
	\rotatebox{-90}{\includegraphics[width=.4\textwidth]{liberator}}
\end{wrapfigure}
...
\begin{wrapfigure}[9]{R}{.5\textwidth}
	\centering
	\includegraphics[width=.7\textwidth,trim={0 13cm 0 2cm},clip]{grannyHatAndGrandad}
\end{wrapfigure}
...
\paragraph{1956} Grandad and Granny Hat moved into their first house in Beulah Road with their newly-born (1954) son, Richard.
...
\begin{wrapfigure}{R}{.5\textwidth}
	\centering
	\includegraphics[width=.7\textwidth,trim={4cm 2cm 5.5cm 15cm},clip]{grannyHatAndGrandad}
\end{wrapfigure}
...
\begin{wrapfigure}{R}{.5\textwidth}
	\centering
	\includegraphics[width=.7\textwidth,trim={13cm 0cm 2cm 0cm},clip]{grandadAndAuntyPam}
\end{wrapfigure}
...
\rotatebox{90}{%
	\begin{tikzpicture}[
		...
		% Parents
		\coordinate
		child[grow=left] {node[man,anchor=east]{Gabriel Edward Hughes}} % 1887--1966
		child[grow=right] {node[woman,anchor=west]{Sarah Constance Cuming}} % 1897--1954
		child[grow=down,level distance=0ex]
		[edge from parent fork down]
		child{
			node[man] {(Edward) Michael} % 1925--2000
			child[grow=right,xshift=2cm]{node[woman] {Pat Jewitt}} % 1923--2000
			child {
				node[man]{Richard} % 1954--
				child[grow=right,xshift=1cm] {node[woman]{Theresa Lyons}} % 1953--
				child[grandchild,first] {
					node[man]{Chris}
					child[grandchild spouse,xshift=-.5cm] {node[woman]{Marisa Moon}}
				}
				child[grandchild,second] {node[man]{David}}
				child[grandchild,third]{node[woman]{Katie}}
			}
		}
		child {node[woman]{Pamela} % --2007
			child[grow=right,xshift=1cm]{node[man] {Keith Beard}} %
			child {node[man,xshift=-1.5cm]{Anthony}
				child[grow=right,xshift=1.5cm] {node[woman]{Claire Stevenson-Jones}}
				child[grandchild,first] {node[woman]{Sarah}}
				child[grandchild,second]{node[woman]{Kathryn}}
			}
			child[xshift=6cm] {
				node[woman]{Hilary}
				child[grow=right,xshift=1cm] {node[man]{Mike Roberts}}
				child[grandchild,first] {node[man]{Paul}}
				child[grandchild,second]{node[woman]{Cara}}
			}
		};
	\end{tikzpicture}
}

\includepdf[pages=-,pagecommand={\pagestyle{fancy}}]{OrderofService.pdf}
